    ...
    <div class="row">
        <div class="col-sm-12">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="active"><a href="index_publishing_houses.php">Publishing houses</a></li>
                ...
                <table class="table table-bordered table-striped" style="background-color: white !important;">
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo '<tr> <td><a href="publish_house.php?ph_id='.$row['id'].'">' . $row['house_name'] . '</a></td> 
                           <td><a href="publish_house.php?ph_id='.$row['id'].'">' . $row['address'] . '</a></td></tr>';
                        }
