...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!empty($_POST['name']) && !empty($_POST['address'])) {
        ...
        $insert_publish_house = "INSERT INTO publishing_houses (house_name,address) VALUES ('$name','$address')";
        $result = mysqli_query($connection, $insert_publish_house);
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Add publishing house</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">New publish house</h3>
                </div>
                <!-- /.box-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text"  name="name" class="form-control" placeholder="publish house">
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                            ...
                            <br>
                            <div class="pull-right">
                                <button type="submit" class="btn btn-success">Add publish house</button>
                            </div>
                        </div>
                    </div>
