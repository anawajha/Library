...
if(isset($_GET['del'])) {
    $del_id=$_GET['del'];
    $delete = "DELETE FROM publishing_houses WHERE id = $del_id";
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Manage books or magazines</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
                <li class="active">publishing houses</li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <table class="table table-bordered table-striped" style="background-color: white !important;">
                ...
                <tbody>
                <?php
                $get_books = "SELECT * FROM publishing_houses ORDER BY id";

                $result = mysqli_query($connection, $get_books);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr><td>' . $row['id'] . '</td> <td>' . $row['house_name'] . '</td> <td>' . $row['address'] . '</td>
                  <td>
                       <a href="edit_publishing_house.php?ph_id='. $row['id'] .'"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                       <a href="publishing_houses_management.php?del='. $row['id'] .' " onclick="return confirm("Are you sure you want to delete?");"" >  <button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
                  </td> </tr>';
                    }
            ...
            <a href="add_publishing_house.php">
                <button type="button" class="btn btn-primary"><span class="fa fa-plus-circle"> </span> &nbsp; Add publishing house</button>
            </a>
