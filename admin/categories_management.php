...
if(isset($_GET['del'])) {
    $del_id=$_GET['del'];
    $delete = "DELETE FROM categories WHERE id = $del_id";
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table class="table table-bordered table-striped" style="background-color: white !important;">
                ...
                <tbody>
                <?php
                $get_books = "SELECT * FROM categories ORDER BY id";

                $result = mysqli_query($connection, $get_books);
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr><td>' . $row['id'] . '</td> <td>' . $row['CategoryName'] . '</td>
                  <td>
                       <a href="edit_category.php?cat_id='. $row['id'] .'"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                       <a href="categories_management.php?del='. $row['id'] .' " onclick="return confirm("Are you sure you want to delete?");"" >  <button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
                  </td> </tr>';
                    }
            ...
            <a href="add_category.php">
                <button type="button" class="btn btn-primary"><span class="fa fa-plus-circle"> </span> &nbsp; Add Category</button>
            </a>
