...
if (isset($_GET['author_id'])){
    ...
    $get_old_data = "SELECT * FROM authors WHERE id = $author_id limit 1";
            ...
            <div class="box box-default">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (!empty($_POST['author'])) {
                        ...
                        $update_author = "UPDATE authors SET authorName = '$author' WHERE id =$author_id ";
                        $result = mysqli_query($connection, $update_author);
                    }
                }
                ?>
                <!-- /.box-header -->
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group">
                                ...
                                <input type="text" name="author" class="form-control" value="<?php if (isset($row)){ echo $row['authorName']; } ?>"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input type="file" name="author_img" value="<?php if (isset($row)){ echo 'http://localhost/finalProject/' . $row['picture']; } ?>"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
