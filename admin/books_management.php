...
if(isset($_GET['del'])) {
    $del_id=$_GET['del'];
    $delete = "DELETE FROM books WHERE id = $del_id";
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="books_management.php"><i class="fa fa-book"></i> <span>Books</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <table class="table table-bordered table-striped" style="background-color: white !important;">
                ...
                <tbody>
                <?php
                $get_books = "SELECT b.cover, b.id, b.title, b.ISBNNumber , a.authorName, c.CategoryName, ph.house_name
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo '<tr><td>' . '<img width="150" height="210" src=" '.'http://localhost/finalProject/' . $row['cover']. ' "> </td> <td>' . $row['id'] . '</td> <td>' . $row['title'] . '</td> <td>' . $row['authorName'] . '</td> <td>' . $row['ISBNNumber'] .
                            '</td> <td>' . $row['CategoryName'] . '</td> <td>' . $row['house_name'] . ' </td>
                  <td>
                       <a href="edit_book.php?book_id='. $row['id'] .' "><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                       <a href="books_management.php?del='. $row['id'] .' "" >  <button class="btn btn-danger"><i class="fa fa-trash"></i> Delete</button>
                  </td> </tr>';
                    }
            ...
            <a href="add_book.php">
                <button type="button" class="btn btn-primary"><span class="fa fa-plus-circle"> </span> &nbsp; Add Book
                </button>
            </a>
