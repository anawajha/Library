...
if (isset($_GET['cat_id'])) {
    $cat_id = $_GET['cat_id'];
    $get_old_data = "SELECT CategoryName FROM categories WHERE id = $cat_id limit 1";
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="publishing_houses_management.php"><i class="fa fa-home"></i> <span>publishing houses</span></a>
                </li>
                <li class="active"><a href="categories_management.php"><i class="fa fa-file-archive-o"></i>
            ...
            <div class="box box-default">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    if (!empty($_POST['cat'])) {
                        ...
                        $insert_category = "UPDATE categories SET CategoryName = '$category' WHERE id = $cat_id";
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cat" class="form-control" value="<?php if (isset($row)) {
