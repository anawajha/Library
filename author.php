...
$get_category = "SELECT * FROM authors WHERE id = $author_id LIMIT 1";
...
<div class="container content">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <ul class="breadcrumb">
                ...
                <li class="active"><?php echo $row['authorName']; ?></li>
            </ul>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-4">
            <h2><?php echo $row['authorName']; ?></h2> </div>
    </div>
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="col-lg-3">
                <div class="row">
                    <div class="coverItem"> <?php echo'<img width="250" height="250" src=" '.'http://localhost/finalProject/' . $row['picture']. '" calss>' ; ?> </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-lg-4">
            <h2><?php echo $row['authorName'] . ' Books'; ?></h2> </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="media">
                    ...
                    <div class="media-body"> <span class="media-heading" style="font-weight: bold">Middle aligned media</span>
                        <p>Lorem ipsum pain sit amet, consectetur adipisicing elit. Dolorem quis quam quasi harum saepe consequuntur ea quod odit veniam sunt. She fugiat voluptate aspernatur, voluptates corrupti consequatur rem inventore quibusdam iure.</p>
                    </div>
                </div>
                <div class="media">
                    <div class="media-left media-middle">
                    ...
                    <div class="media-body"> <span class="media-heading" style="font-weight: bold">Middle aligned media</span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorem quis quam quasi harum saepe consequuntur ea quod odit veniam sunt. Fugiat voluptate aspernatur, voluptates corrupti consequatur rem inventore quibusdam iure.</p>
                    </div>
                </div>
            </div>
        </div>
