...
include_once 'database/db_connection.php';
      ...
      if (isset($_GET['ph_id'])) {
      $ph_id = $_GET['ph_id'];
      $get_publish_house = "SELECT * FROM publishing_houses WHERE id = $ph_id LIMIT 1";
      $result = mysqli_query($connection, $get_publish_house);
...
<div class="container content">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <ul class="breadcrumb">
                ...
                <li class="active"> <?php echo $row['house_name']; ?> </li>
            </ul>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-4">
            <h2> <?php echo $row['house_name']; ?> </h2>
            <h4><i class="fa fa-map-marker" style="color: red; margin-bottom: 20px"></i> <?php echo $row['address']; ?> </h4>
    ...
    <div class="row">
        <h2> <?php echo $row['house_name'] . " books"; ?></h2>
    </div>
            ...
            <div>
                <div>
                    <div>
                        ...
                        WHERE publishing_houses.id = $ph_Id";
